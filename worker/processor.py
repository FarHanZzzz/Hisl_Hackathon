"""
Video Processing Worker for Pedi-Growth.
Handles frame-by-frame gait analysis using MediaPipe.
"""
...
from shared.utils import calculate_angle, clean_angle_data, calculate_symmetry_index, get_diagnosis
    ...
    def __init__(self, model_path: str = None):
        ...
        if model_path is None:
            ...
            possible_paths = [
                ...
                Path(__file__).parent.parent / "Pedi-Growth" / "pose_landmarker_heavy.task",
            ]
