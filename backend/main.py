...
async def create_job(
    ...
    The job will be processed asynchronously by the worker service.
    """
    ...
    # In production, this would queue the job to a message broker (Redis, RabbitMQ)
...
async def process_job_async(job_id: str):
    ...
    try:
        ...
        # Create mock result (in production, this comes from the worker)
        from shared.schemas import (
            AnalysisResult,
            AnalysisMetrics,
            AngleData,
